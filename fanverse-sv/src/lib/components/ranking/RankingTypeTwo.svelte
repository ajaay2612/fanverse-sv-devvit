        ...
        <div class="relative w-[calc(100%-15em)] mx-auto flex">
            <div class="absolute flex flex-col gap-1em left-[2.6em]  ">
                {#each $postDataRanking.allLoadedData as rankers, i}
                    <div class="">
                        <div class="text-[3.5em] aspect-[3/4] h-[1.72em] flex justify-center items-center">
                            <p>{i+1}</p>
                        </div>
                    </div>
                {/each}
            ...
            <div class="flex flex-col gap-1em w-full">
                {#each $postDataRanking.allLoadedData as rankers, i}
                    ...
                    class="relative flex justify-center items-center h-[6em] gap-0em">
                        ...
                        {/if}
                        <div class="bg-green-100 opacity-0 pointer-events-none text-[3.5em] aspect-[3/4] h-full flex justify-center items-center">
                            <p>{i+1}</p>
                        </div>
