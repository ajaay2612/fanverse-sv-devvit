...
<div class="overflow-scroll px-2em w-full">
    <div class="w-[66.3em] flex justify-center items-center mx-auto">
        <div class="w-full">
            ...
            <div class="text-[1.4em] xsm:text-[0.65em] lg:text-[0.61em]">
                <div class="relative mx-auto w-[14em]">
                    <button
